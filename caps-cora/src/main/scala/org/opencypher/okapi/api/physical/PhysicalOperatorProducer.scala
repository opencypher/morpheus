...
import org.opencypher.okapi.impl.table.{ProjectedExpr, ProjectedField, RecordHeader}
...
/**
  ...
  * called by [[org.opencypher.okapi.impl.physical.PhysicalPlanner]], a default implementation for physical planning.
  *
