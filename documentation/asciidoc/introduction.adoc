...
If your identifier has a different data type, you need to convert it to one of the supported types before a CAPS table.

Using this mechanism, you can re-use identifiers that you might already have, e.g. in a CSV file or a relational table.
Note, that identifiers must be unique within the set of all nodes and within the set of all relationships.
