...
final case class PatternScan(node: Var, rel: Var, nodeRelPattern: NodeRelPattern, in: LogicalOperator, solved: SolvedQueryModel)
  extends StackingLogicalOperator {
  override val fields: Set[Var] = in.fields + node + rel
}
