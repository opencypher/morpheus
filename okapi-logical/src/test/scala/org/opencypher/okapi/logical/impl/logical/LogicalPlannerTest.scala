...
//    result.show()
//
//    val expected = Select(List(Var("a.name")(CTNull)),
//      Project(Property(Var("a")(CTNode(Set("Administrator"))), PropertyKey("name"))(CTNull) -> Some(Var("a.name")(CTNull)),
//        Filter(
