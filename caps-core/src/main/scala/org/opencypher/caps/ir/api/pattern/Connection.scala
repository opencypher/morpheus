...
import org.opencypher.caps.ir.api.pattern.Orientation.{Cyclic, Directed, Undirected}
...
final case class DirectedVarLengthRelationship(endpoints: DifferentEndpoints, lower: Int, upper: Option[Int])
