...
class Neo4JPropertyGraphDataSourceUnitTest extends BaseTestSuite {
  ...
  private val pgds = Neo4jPropertyGraphDataSource(Neo4jConfig(URI.create("test://foo")), GraphName(entireGraph))(mock[CAPSSession])
