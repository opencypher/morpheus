...
import org.opencypher.spark.impl.graph.MorpheusGraphFactory
import org.opencypher.spark.impl.table.SparkTable.DataFrameTable
import org.opencypher.spark.impl.{MorpheusRecords, MorpheusRecordsFactory}
...
object MorpheusSession extends Serializable {
  ...
  /**
    * Creates a new [[org.opencypher.spark.api.MorpheusSession]] based on the given [[org.apache.spark.sql.SparkSession]].
    *
  ...
  /**
    ...
    *
    * {{{
    * import org.opencypher.spark.api.MorpheusSession.RecordsAsDF
    * // ...
