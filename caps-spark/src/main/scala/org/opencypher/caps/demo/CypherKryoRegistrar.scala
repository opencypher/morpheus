...
//    classOf[Array[CypherValue]],
    ...
    classOf[Array[CypherNode[Long]]],
    classOf[Array[CypherRelationship[Long]]],
//    classOf[Array[CypherPath]],
//    (List.empty[MaterialCypherValue]: CypherList[MaterialCypherValue]).getClass,
//    classOf[Array[CypherList[_]]],
