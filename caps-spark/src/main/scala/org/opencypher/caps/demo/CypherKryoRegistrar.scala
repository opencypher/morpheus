...
class CypherKryoRegistrar extends SparkKryoRegistrar {
  ...
  private val registeredClasses = Seq(
      ...
      classOf[CAPSBoolean],
      classOf[CAPSMap],
      CAPSMap.empty.getClass,
      classOf[CAPSNode],
      classOf[CAPSRelationship],
      classOf[CAPSPath],
      classOf[CAPSList],
      CAPSList.empty.getClass,
      classOf[Properties],

      classOf[Array[CAPSValue]],
      classOf[Array[CAPSInteger]],
      classOf[Array[CAPSFloat]],
      classOf[Array[CAPSNumber]],
      classOf[Array[CAPSString]],
      classOf[Array[CAPSBoolean]],
      classOf[Array[CAPSMap]],
      classOf[Array[CAPSNode]],
      classOf[Array[CAPSRelationship]],
      classOf[Array[CAPSPath]],
      classOf[Array[CAPSList]],
