...
import org.opencypher.okapi.api.io.GraphEntity.sourceIdKey
import org.opencypher.okapi.api.io.EntityTable._
...
import org.opencypher.okapi.impl.spark._
import org.opencypher.okapi.impl.util.Annotation
...
trait CAPSEntityTable extends EntityTable[SparkTable] {
  ...
  private[okapi] def entityType: CypherType with DefiniteCypherType = mapping.cypherType

  private[okapi] def records(implicit caps: CAPSSession): CAPSRecords = CAPSRecords.create(this)
}
