...
//import org.opencypher.caps.impl.spark.io.hdfs.{HdfsCsvPropertyGraphDataSource, HdfsCsvPropertyGraphDataSourceTest}
...
//    val SN_US = caps.readFrom(neoRegionGraph("US"))
...
//    }
//
//    val resultGraph = caps.readFrom(neoRegionGraph("US"))
...
//    new Neo4jPropertyGraphDataSource(neo4jConfig, Some(nodeQuery -> relQuery)).graph(GraphName.create("foo"))
//  }
//
