...
trait CypherSession {
  ...
  /**
    ...
    */
  def cypher(query: String, parameters: Map[String, CypherValue[_]] = Map.empty): CypherResult
  ...
  /**
    ...
    * @return result of the query
    */
  private[graph] def cypherOnGraph(graph: PropertyGraph, query: String, parameters: Map[String, CypherValue[_]] = Map.empty): CypherResult
