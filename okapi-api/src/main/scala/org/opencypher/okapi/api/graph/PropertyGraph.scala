...
trait PropertyGraph extends GraphOperations {
  ...
  /**
    ...
    */
  def nodes(name: String, nodeCypherType: CypherType = CTAnyNode): CypherRecords
  ...
  /**
    ...
    */
  def relationships(name: String, relCypherType: CypherType = CTAnyRelationship): CypherRecords
