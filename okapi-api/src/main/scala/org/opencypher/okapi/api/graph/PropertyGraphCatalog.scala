...
trait PropertyGraphCatalog {
  ...
  /**
    ...
    *
    * @return
    *   a map of all PGDS registered at this catalog, keyed by their
    *   [[org.opencypher.okapi.api.graph.Namespace]]s.
    */
  ...
  /**
    ...
    * [[org.opencypher.okapi.api.graph.Namespace]] within this catalog.
    *
    ...
    * [[org.opencypher.okapi.api.graph.Namespace]]. Use
    * [[org.opencypher.okapi.api.graph.PropertyGraphCatalog#deregisterSource]] first.
    *
    * @param namespace
    *   namespace for lookup
    * @param dataSource
  ...
  /**
    * De-registers a [[org.opencypher.okapi.api.io.PropertyGraphDataSource]] from the catalog by its
    * given [[org.opencypher.okapi.api.graph.Namespace]].
    *
    * @param namespace
    *   namespace for lookup
    */
  ...
  /**
    * Returns a set of [[org.opencypher.okapi.api.graph.QualifiedGraphName]]s for
    * [[org.opencypher.okapi.api.graph.PropertyGraph]]s that can be provided by this catalog.
    *
    * @return
    *   qualified names of graphs that can be provided
    */
  def graphNames: Set[QualifiedGraphName]

  /**
    * Returns a set of [[org.opencypher.okapi.api.graph.QualifiedGraphName]]s for stored view
    * queries that can be provided by this catalog.
    *
    * @return
    *   qualified names of view queries that can be provided
    */
  def viewNames: Set[QualifiedGraphName]

  /**
    * Returns all the qualified graph names known to this catalog. These identify either graphs
    * stored in property graph data sources or view queries stored directly in the catalog.
    *
    * @return
    *   qualified names of graphs and view queries
    */
  def catalogNames: Set[QualifiedGraphName] = graphNames ++ viewNames

  /**
    * Stores the given [[org.opencypher.okapi.api.graph.PropertyGraph]] using the
    * [[org.opencypher.okapi.api.io.PropertyGraphDataSource]] registered under the
    * [[org.opencypher.okapi.api.graph.Namespace]] of the specified string representation of a
  ...
  /**
    * Stores the given [[org.opencypher.okapi.api.graph.PropertyGraph]] using the
    * [[org.opencypher.okapi.api.io.PropertyGraphDataSource]] registered under the
    * [[org.opencypher.okapi.api.graph.Namespace]] of the specified
    * [[org.opencypher.okapi.api.graph.QualifiedGraphName]].
    *
    * @param qualifiedGraphName
    *   qualified graph name
  ...
  /**
    ...
    * The view may be parameterized with graph references. Graph reference parameters may only be
    * used in FROM clauses in the view definition.
    *
    * @param qualifiedGraphName
    *   qualified graph name
    * @param parameterNames
    *   list of graph reference parameters used in the view query
    * @param viewQuery
    *   query string for the view definition
    */
  def store(
  ...
  /**
    * Removes the [[org.opencypher.okapi.api.graph.PropertyGraph]] with the given qualified graph
    * name.
    *
    * @param qualifiedGraphName
  ...
  /**
    * Removes the [[org.opencypher.okapi.api.graph.PropertyGraph]] with the given qualified name
    * from the data source associated with the specified
  ...
  /**
    * Returns the [[org.opencypher.okapi.api.graph.PropertyGraph]] that is stored at the given
    * [[org.opencypher.okapi.api.graph.QualifiedGraphName]].
    *
    * @param qualifiedGraphName
    *   qualified graph name
  ...
  /**
    * Returns the [[org.opencypher.okapi.api.graph.PropertyGraph]] that is created by the passed
    * [[ViewInvocation]].
    *
    * The view is instantiated with `parameters`.
    *
    * @param viewInvocation
    *   view invocation to execute
    * @return
    *   property graph returned by the parameterized view
    */
  private[opencypher] def view(viewInvocation: ViewInvocation)(implicit
