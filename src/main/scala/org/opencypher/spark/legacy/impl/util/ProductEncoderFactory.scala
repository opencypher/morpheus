package org.opencypher.spark.legacy.impl.util
...
import org.opencypher.spark.legacy.api.frame.EmbeddedRepresentation
import org.opencypher.spark.legacy.api.frame.BinaryRepresentation
import org.opencypher.spark.legacy.impl.StdSlot
