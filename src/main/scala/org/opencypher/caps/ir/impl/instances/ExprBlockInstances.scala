...
import org.opencypher.caps.ir.api.global.{ConstantRegistry, Label}
...
trait ExprBlockInstances {
  ...
  implicit def typedMatchBlock(implicit constants: ConstantRegistry): TypedBlock[MatchBlock[Expr]] =
