...
//    val space = CAPSSession.fromNeo4j("MATCH (n:Tweet) RETURN n LIMIT 100", "RETURN 1 LIMIT 0", schema)
...
//    val space = CAPSSession.fromNeo4j(
//      "RETURN 1 LIMIT 0",
...
//    val schema = CAPSSession.loadSchema("MATCH (a) RETURN a", "MATCH ()-[r]->() RETURN r").schema
//
