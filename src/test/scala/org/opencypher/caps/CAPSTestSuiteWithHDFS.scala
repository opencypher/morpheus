...
abstract class CAPSTestSuiteWithHDFS extends CAPSTestSuite with BeforeAndAfterAll {
  ...
  override def beforeAll {
    dfsCluster = new MiniDFSCluster.Builder(sparkSession.sparkContext.hadoopConfiguration).build()
