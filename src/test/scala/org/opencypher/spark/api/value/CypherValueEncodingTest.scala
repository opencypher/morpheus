...
class CypherValueEncodingTest extends TestSuiteImpl with TestSparkCypherSession.Fixture {

  import CypherTestValues._

  test("PATH encoding") {
    val values = PATH_valueGroups.flatten
    val ds = sparkSession.createDataset[CypherValue](values)(Encoders.cypherValueEncoder)
