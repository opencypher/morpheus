...
class NullTests extends MorpheusTestSuite with ScanGraphInit with TestNameFixture {
  ...
  describe("null input produces null") {
    ...
    it("calling: head(null)")(returnsNull())
    it("calling: last(null)")(returnsNull())
    it("calling: tail(null)")(returnsNull())
    ...
    it("calling: split(null, null)")(returnsNull())
    it("calling: reverse(null)")(returnsNull())
    ...
    it("calling: null XOR null")(returnsNull())
  }
