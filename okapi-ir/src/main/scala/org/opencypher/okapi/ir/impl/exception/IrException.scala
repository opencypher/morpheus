...
abstract class IrException(msg: String, cause: Option[Throwable] = None)
    extends InternalException(msg, cause)

final case class PatternConversionException(msg: String) extends IrException(msg)

final case class TypingException(msg: String, cause: Option[Throwable] = None)
    extends IrException(msg, cause)
